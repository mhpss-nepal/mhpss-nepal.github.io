...
window.I18N_STRINGS = {
  ...
  en: {
    ...
    "refdir.find.intro": "Choose what you are looking for. The map shows where it is, and the list beside it says who provides it and where that information comes from: a hospital’s own website, or a partner’s report to this group. The two are kept apart.",
    ...
    "refdir.find.outside": "Outside the map (Lalitpur)",
    "refdir.find.clear": "Clear filters",
    "refdir.find.maph": "How many places match, palika by palika",
    "refdir.find.hint": "Select a district’s name, a palika or a number to narrow the list to that place; the map then frames that district. Select the palika again, or Whole map, to widen it.",
    ...
    "refdir.find.place.outside": "{district} · outside the map",
    ...
    "refdir.find.scope": "<b>Hospitals</b> — the district and provincial hospitals of the districts on the map, and five referral hospitals in Kathmandu and Lalitpur, read on their own websites on 17 September 2026. A hospital is listed only for what its own pages say, quoted in its own words. For a hospital, <i>provider</i> means a psychiatry department, unit or consultants named there, never a person. Private hospitals and clinics have not been checked. A listing does not mean a service is open today: call before travelling. <b>Partner organisations</b> — published by the Technical Working Group from partners’ activity reports; see section 4.",
  ...
  ne: {
    ...
    "refdir.find.hint": "सूचीलाई त्यस स्थानमा सीमित गर्न जिल्लाको नाम, कुनै पालिका वा कुनै संख्या छान्नुहोस्; त्यसपछि नक्साले त्यो जिल्ला ठूलो गरी देखाउँछ। सूची फेरि फराकिलो बनाउन सोही पालिका फेरि छान्नुहोस्, वा ‘पूरै नक्सा’ छान्नुहोस्।",
    "refdir.find.intro": "आफूले खोजेको कुरा छान्नुहोस्। नक्साले त्यो कहाँ छ भन्ने देखाउँछ, र छेउको सूचीले त्यो कसले प्रदान गर्छ र त्यो जानकारी कुन स्रोतबाट आएको छ भन्ने बताउँछ: अस्पतालको आफ्नै वेबसाइट, वा साझेदारले यो समूहलाई पठाएको प्रतिवेदन। यी दुई स्रोतलाई छुट्टाछुट्टै राखिएको छ।",
    "refdir.find.key.dhit": "जिल्लामा मिल्ने संख्या, जिल्लाको नामसँगै",
    "refdir.find.key.hit": "पालिकामा मिल्ने स्थानको संख्या",
    "refdir.find.last": "पछिल्लो प्रतिवेदन {date}",
    "refdir.find.maph": "पालिकागत रूपमा मिल्ने स्थानको संख्या",
    ...
    "refdir.find.outside": "नक्साबाहिर (ललितपुर)",
